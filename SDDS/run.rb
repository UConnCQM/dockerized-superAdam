...
case param
	when "help"
		puts "SDDS module simulates the average trajectory for each variable out of numberofSimulations trajectories deterministically or stochastically."
		puts ""
		puts "Usage: ./run.rb [help|check|<input_file.json>]"
		puts ""
		puts "* check: run all json tests file against SDDS and compares them to reference output files"
